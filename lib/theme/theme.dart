...
import 'package:weshoping/theme/colors.dart';

class AppTheme{
  static final ThemeData apptheme = ThemeData(
    primarySwatch: Colors.blue,
    backgroundColor: AppColor.white,
    accentColor: WeshopingColor.dodgetBlue,
    ...
    appBarTheme: AppBarTheme(
      brightness: Brightness.light,
      color: WeshopingColor.white,
      iconTheme: IconThemeData(color: WeshopingColor.dodgetBlue,),
      elevation: 0,
      textTheme:  TextTheme(
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      backgroundColor:   WeshopingColor.dodgetBlue,
    ),
